...
const TRANSLATIONS = {
  tr: {
    ...
    notification_updated_title: "Menü Güncellendi",
    notification_updated_body: "Bugünün menüsünde güncellemeler yapıldı! Yeni menüyü görmek için tıklayın.",
  ...
  az: {
    ...
    notification_updated_title: "Menu Yeniləndi",
    notification_updated_body: "Bugünün menusunda yeniliklər edildi! Yeni menunu görmək üçün klikləyin.",
  ...
  ar: {
    ...
    notification_updated_title: "تم تحديث القائمة",
    notification_updated_body: "تم إجراء تحديثات على قائمة اليوم! انقر لعرض القائمة الجديدة.",
