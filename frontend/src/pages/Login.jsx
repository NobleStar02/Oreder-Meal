    ...
    <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="relative h-full flex flex-col justify-between p-12 text-white">
          <Link to="/" className="flex items-center gap-2.5">
            ...
            <div className="leading-tight">
              ...
              <div className="text-[10px] uppercase tracking-[0.2em] opacity-80">{t("logo_subtitle")}</div>
            </div>
          </Link>
          <div className="max-w-md">
            <div className="text-xs uppercase tracking-[0.25em] font-bold opacity-80 mb-3">{t("hero_badge")}</div>
            <div className="font-heading text-4xl font-bold leading-tight">"{t("hero_title")}"</div>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-6 md:p-12 bg-[#F9F6F0]">
        <div className="w-full max-w-md">
          ...
          <h1 className="font-heading text-4xl font-bold tracking-tight text-[#2C2A29]">{t("login_title")}</h1>
          <p className="text-[#5C5855] mt-2">{t("login_desc")}</p>

          <form onSubmit={onSubmit} className="mt-8 space-y-5" data-testid="login-form">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-[#2C2A29] font-medium">{t("login_email")}</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-[#2C2A29] font-medium">{t("login_password")}</Label>
              <Input
